# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-13 14:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modified_time', models.DateField(auto_now_add=True, verbose_name='修改时间')),
                ('status', models.CharField(choices=[('d', 'Draft'), ('p', 'Published')], max_length=1, verbose_name='文章状态')),
                ('abstract', models.CharField(blank=True, help_text='可选，如若为空讲摘取正文的前54个字符', max_length=54, null=True, verbose_name='摘要')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateField(auto_now_add=True, verbose_name='创建时间')),
                ('modified_time', models.DateField(auto_now_add=True, verbose_name='修改时间')),
            ],
        ),
        migrations.AddField(
            model_name='article',
